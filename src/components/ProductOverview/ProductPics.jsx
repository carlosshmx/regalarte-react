function ProductPics() {
  return (
    <div id="default-carousel" className="relative w-2/5" data-carousel="static">
      {/* <!-- Carousel wrapper --> */}
      <div className="relative h-56 overflow-hidden rounded  md:rounded-l-lg md:h-screen">
        {/* <!-- Item 1 --> */}
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
          <img
            src="https://res.cloudinary.com/carlosshmc/image/upload/v1626984736/Regalarte/100035400698-189450-01_szzok6.jpg"
            className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="..."
          />
        </div>
